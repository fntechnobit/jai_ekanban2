            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title mb-0">
                        <i class="fa-solid fa-diagram-project"></i> Cutting
                    </h3>
...
@section('script')
    ...
    <script>
        ...
        var FILTER_STORAGE_KEY = 'ekanban_circuit_print_machine_filters';
        ...
        $(function () {
            ...
            if (savedFilters) {
                ...
                $('#filter_area, #filter_type, #filter_shift, #filter_cutoff, #filter_print_status').trigger('change.select2');
            }
            ...
            table = $('#circuit-table').DataTable({
                ...
                ajax: {
                    ...
                    error: function(xhr, error, thrown) {
                        // Detect session expiry (redirect to login returns HTML)
                        ...
                        // Show error in table without breaking it
            ...
            $('#filter_area, #filter_machine, #filter_type, #filter_shift, #filter_cutoff, #filter_print_status').on('change', function() {
                ...
                if (machine) {
                    table.ajax.reload();
                    startAutoRefresh(); // restart countdown after manual reload
                } else {
                    stopAutoRefresh();
                }
            });
