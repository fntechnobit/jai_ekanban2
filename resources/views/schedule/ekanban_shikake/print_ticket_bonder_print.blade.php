{{-- BONDER Process Print Template - PRINT VERSION --}}
<style>
/* BONDER Print Template - Wrapper for Image + Ticket */
...
.ticket-bonder-print .info-table {
    width: 100%;
...
.ticket-bonder-print .info-table th,
.ticket-bonder-print .info-table td {
...
.ticket-bonder-print .detail-table {
    width: 100%;
    border-collapse: collapse;
    font-size: 10px;
    margin-bottom: 3px;
...
.ticket-bonder-print .detail-table td {
    border: 1px solid #000;
    padding: 2px 4px;
}

.ticket-bonder-print .detail-table .label {
    font-weight: 600;
    background: #f0f0f0;
    text-align: center;
}

.ticket-bonder-print .detail-table .value {
    text-align: center;
}

.ticket-bonder-print .section-a {
    background: #000;
    color: #fff;
    font-weight: bold;
    text-align: center;
...
.ticket-bonder-print .barcode-section {
    width: 100%;
    border-collapse: collapse;
    font-size: 10px;
}

.ticket-bonder-print .barcode-section td {
    border: 1px solid #000;
    padding: 3px;
}

.ticket-bonder-print .barcode-header {
    text-align: center;
    font-weight: bold;
    background: #ffeeba;
}
