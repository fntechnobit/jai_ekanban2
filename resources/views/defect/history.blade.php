...
$(function () {
    ...
    function getColumns(type) {
        ...
        cols.push(
            { data: 'qty_display', name: 'qty_defect', className: 'text-end' },
    ...
    var table = $('#history-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('defect.history.datatable') }}",
            data: function (d) {
                d.type = currentType;
    ...
    function switchType(type) {
        ...
        var thead = '<tr>' +
            ...
            '<th>Code</th>';
        if (type === 'shikake') {
            thead += '<th width="8%">Type</th>';
        }
        thead += '<th width="7%">Qty</th>' +
            '<th width="7%">Before</th>' +
            '<th width="7%">After</th>' +
            '<th width="14%">Reason</th>' +
            '<th width="10%">Created By</th>' +
            '</tr>';
        $('#history-table thead').html(thead);
