<!-- Import Modal -->
<div class="modal fade" id="importShikakeModal" tabindex="-1"  aria-labelledby="importShikakeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form id="importShikakeForm" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm" id="btn-submit-import-shikake">
