            ...
            <form id="removeDataForm" novalidate>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>Warning!</strong> This action will permanently delete all Circuit data on the selected conveyor that match the chosen type and machine (all of them when left empty).
                    </div>
                </div>
