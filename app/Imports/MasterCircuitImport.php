...
class MasterCircuitImport
{
    ...
    protected function mapRowToData($rowData, $conveyor)
    {
        ...
        return [
            ...
            'released_note' => ImportHelper::cleanValue($rowData[7] ?? null),   // Column H - Released Note
            'cust_no' => ImportHelper::cleanValue($rowData[8] ?? null),         // Column I - Cust No.
            'barcode_mesin' => ImportHelper::cleanValue($rowData[9] ?? null),   // Column J - Barcode Mesin
            'address' => ImportHelper::cleanValue($rowData[10] ?? null),        // Column K - Address
            'cct_code' => ImportHelper::cleanValue($rowData[11] ?? null),       // Column L - CCT Code
            'kind' => ImportHelper::cleanValue($rowData[12] ?? null),           // Column M - Kind
            'size' => ImportHelper::cleanValue($rowData[13] ?? null),           // Column N - Size
            'col' => ImportHelper::cleanValue($rowData[14] ?? null),            // Column O - Col
            'cl' => ImportHelper::cleanValue($rowData[15] ?? null),             // Column P - C/L
            'terminal_1' => ImportHelper::cleanValue($rowData[16] ?? null),     // Column Q - Terminal 1
            'note_1' => ImportHelper::cleanValue($rowData[17] ?? null),         // Column R - Note 1
            'gold_1' => ImportHelper::cleanValue($rowData[18] ?? null),         // Column S - Gold 1
            'strip_1' => ImportHelper::cleanValue($rowData[19] ?? null),        // Column T - Strip 1
            'acc_1' => ImportHelper::cleanValue($rowData[20] ?? null),          // Column U - Acc. 1
            'acc_1a' => ImportHelper::cleanValue($rowData[21] ?? null),         // Column V - Acc. 1A
            'tube_1' => ImportHelper::cleanValue($rowData[22] ?? null),         // Column W - Tube 1
            'mark_1' => ImportHelper::cleanValue($rowData[23] ?? null),         // Column X - Mark 1
            'remark_1' => ImportHelper::cleanValue($rowData[24] ?? null),       // Column Y - Remark 1
            'terminal_2' => ImportHelper::cleanValue($rowData[25] ?? null),     // Column Z - Terminal 2
            'note_2' => ImportHelper::cleanValue($rowData[26] ?? null),         // Column AA - Note 2
            'gold_2' => ImportHelper::cleanValue($rowData[27] ?? null),         // Column AB - Gold 2
            'strip_2' => ImportHelper::cleanValue($rowData[28] ?? null),        // Column AC - Strip 2
            'acc_2' => ImportHelper::cleanValue($rowData[29] ?? null),          // Column AD - Acc 2
            'acc_2a' => ImportHelper::cleanValue($rowData[30] ?? null),         // Column AE - Acc 2A
            'tube_2' => ImportHelper::cleanValue($rowData[31] ?? null),         // Column AF - Tube 2
            'mark_2' => ImportHelper::cleanValue($rowData[32] ?? null),         // Column AG - Mark 2
            'remark_2' => ImportHelper::cleanValue($rowData[33] ?? null),       // Column AH - Remark 2
            'ta' => ImportHelper::cleanValue($rowData[34] ?? null),             // Column AI - TA
            'tb' => ImportHelper::cleanValue($rowData[35] ?? null),             // Column AJ - TB
            't01' => ImportHelper::cleanValue($rowData[36] ?? null),            // Column AK - T01
            't02' => ImportHelper::cleanValue($rowData[37] ?? null),            // Column AL - T02
            't03' => ImportHelper::cleanValue($rowData[38] ?? null),            // Column AM - T03
            't04' => ImportHelper::cleanValue($rowData[39] ?? null),            // Column AN - T04
            't05' => ImportHelper::cleanValue($rowData[40] ?? null),            // Column AO - T05
            't06' => ImportHelper::cleanValue($rowData[41] ?? null),            // Column AP - T06
            'created_by' => Auth::id(),
        ];
    }
