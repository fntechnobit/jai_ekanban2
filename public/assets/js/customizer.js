$(function() {
  //  **------Load customizer**
  var assetBase = (typeof ASSET_URL !== 'undefined') ? ASSET_URL : '/adminx/';
  $.get(assetBase + "assets/customizer.txt", function(html_string)
  {
...
$(document).on("click",".sidebar-option > li", function () {
  ...
  $("nav.app-sidebar, nav.dark-sidebar, nav.horizontal-sidebar, nav.vertical-sidebar").removeClass("horizontal-sidebar vertical-sidebar dark-sidebar").addClass(sidebarClassName);
...
function loadConfiguration(){
  ...
  $("nav.dark-sidebar, nav.horizontal-sidebar, nav.vertical-sidebar").removeClass('dark-sidebar').addClass(selectedSidebarOption);
